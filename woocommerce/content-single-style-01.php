...
<div id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
	<section>
		<div class="detail-book">
			<div class="container">
				<div class="row">
					<div class="book-detail col-md-10 col-sm-10 col-12 book-center">
						<div class="row">
							...
							<div class="book-item-detail col-md-7 col-sm-7 col-12">
								...
								<?php if( $enable_affiliate != true ): ?>
									...
									echo '<div class="book-detail-cart">';
									if ($cart_setting != '1') {
								...
								<?php if ($product_type =="product_audio" && $mp3Files) {
									$i=1;
									?>
								...
								<script>
									(function($) {
										...
										var bookAuthor_<?php echo esc_js($rand_id); ?> = new Swiper('#<?php echo esc_js($idauth);?>', {
											...
											scrollbar: {
												el: '#<?php echo esc_js($idauth);?> .author-book-scrollbar',
											},
											slidesPerView: 3,
											breakpoints: {
												320: {
